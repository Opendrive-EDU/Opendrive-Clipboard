...
class BeaconDemoTest(unittest.TestCase):
    def test_beacon_recording_shape(self):
        recording = mock_beacon_recording("residential-following-distance")
    ...
    def test_beacon_has_no_audio(self):
        recording = mock_beacon_recording("yellow-light-decision")
    ...
    def test_beacon_is_deterministic(self):
        first = mock_beacon_recording("residential-following-distance")
        second = mock_beacon_recording("residential-following-distance")
        self.assertEqual(
...
class GraderTest(unittest.TestCase):
    ...
    def test_report_is_deterministic(self):
        first = grade_drive("residential-following-distance")
        second = grade_drive("residential-following-distance")
        self.assertEqual(
            json.dumps(first, sort_keys=True),
            json.dumps(second, sort_keys=True),
        )
    ...
    def test_ratings_are_in_dol_scale(self):
        report = grade_drive("yellow-light-decision")
